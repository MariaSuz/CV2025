    ...
    list: [
      {
        ...
        description: "I develop and maintain a web portal for managing a network of payment terminals. The application allows real-time monitoring of payments, reconciling data with the acquiring bank, analyzing sales statistics by terminal geolocation, studying customer behavior, and evaluating the effectiveness of loyalty programs. I work in a small team using Git and Jira.",
        achievements: [
          "Adapted and configured a complex filtering and sorting system for new table pages.",
          "Implemented i18n interface translation into two languages.",
          "Improved application performance by conducting refactoring.",
        ],
      ...
      },
      {
        ...
        achievements: [
          ...
          "Migrated the old PHP + jQuery application to new hardware.",
          "Developed and implemented a corporate directory (Vue + Node.js) containing information about offices, positions, phone numbers, regulations, and links to portals. The application is used by 100+ employees daily.",
          "Deployed the application on Windows Server 2019 (IIS): configured frontend hosting, ran the Node.js backend as a Windows service for automatic startup after reboot, and set up URL Rewrite to ensure proper client-side routing for the SPA.",
        ],
        technologies: ["Linux (Debian)", "Windows Server 2008-2019", "1C", "MySQL", "Exim", "Dovecot", "Vue", "Node.js", "IIS"],
      },
    ],
  },
  workExamples: {
